...
public class Materia {
    ...
    private int niveles;
    private ArrayList<model.Paralelo> paralelo;
    private ArrayList<model.Pregunta> preguntas;
    ...
    public void visualizarPreguntas(){
        int i = 1;
        for(model.Pregunta preg : preguntas){
    ...
    public void agregarPreguntas(String enunciado, int nivel, String respuestaCorrecta, ArrayList<String> respuestasIncorrectas){
        model.Pregunta nuevaPregunta = new model.Pregunta(enunciado,nivel,respuestaCorrecta,respuestasIncorrectas);
